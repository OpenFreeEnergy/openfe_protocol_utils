...
from openfe_protocol_utils.settings import omm_settings
...
class TestSettingsFromString:
    def test_solvation_settings(self):
        s = omm_settings.OpenMMSolvationSettings()

        s.solvent_padding = "0.85 nm"

        assert s.solvent_padding == 0.85 * unit.nanometer
